...
def parse_args():
    ...
    parser.add_argument('--ecg_filepath', type=str, default='/data1/1shared/lijun/data/HEEDB/ECG/WFDB/', help="Directory to load chest x-ray image data from.")
    parser.add_argument('--txt_filepath', type=str, default='/data1/1shared/lijun/data/HEEDB/delete_time_label_eval.csv', help="Directory to load radiology report impressions text from.")
    parser.add_argument('--batch_size', type=int, default=128)
    parser.add_argument('--epochs', type=int, default=10)
    parser.add_argument('--lr', type=float, default=1e-4)
    parser.add_argument('--save_interval', type=int, default=100)
    parser.add_argument('--log_interval', type=int, default=100)
    parser.add_argument('--save_dir', type=str, default="/data1/1shared/lijun/ecg/ECGFounder_CLIP/checkpoints/", help="Directory to save the trained model.")
    parser.add_argument('--seed', type=int, default=1234)
    parser.add_argument('--optimizer', type=str, default="adam")
    parser.add_argument('--momentum', type=float, default=0.9)
    parser.add_argument('--context_length', type=int, default=77)
    parser.add_argument('--random_init', action='store_true')
    parser.add_argument('--model_name', type=str, default="delete_time_label")
...
def make(config): 
    ...
    data_loader, device = load_data(config.txt_filepath, batch_size=config.batch_size)
...
def train_log(model):
    config = yaml.load(open("/data1/1shared/lijun/ecg/ECGFounder_CLIP/zero_shot/zeroshot_config.yaml", "r"), Loader=yaml.FullLoader)
